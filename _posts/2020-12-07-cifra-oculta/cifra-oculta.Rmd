...
### Gráfico geral (contagem de casos por assunto top 15)
...
assuntos %>%
  ...
  plot_annotation("Contagem de Assuntos de forma geral",
                  theme = theme(plot.title = element_text(size = rel(1.5)))) +
  labs(x = "Quantidade",
       y = "Assuntos Recorrentes") +
  theme_minimal(8)
```
### Gráficos de nº de casos por tribunal
...
assuntos %>%
  ...
  labs(title = "Contagem de Casos por Tribunal",
       x = "Quantidade",
       y = "Tribunais") +
  theme_minimal(12)
```
### Gráfico nº de casos por ano
...
assuntos %>%
  ...
  labs(title = "Contagem de Casos por Ano",
       x = "Anos",
       y = "Tribunais") +
  theme_minimal(12) +
...
assuntos %>%
  ...
  theme_minimal(9.5) +
  plot_annotation("Taxa de cifra oculta por assuntos genéricos",
                  theme = theme(plot.title = element_text(size = rel(1.5)))) +
...
assuntos %>%
  ...
  scale_x_continuous(labels = scales::percent) +
  theme_minimal(12) +
  labs(title = "Taxa de cifra oculta por tribunal",
       x = "Tribunal",
