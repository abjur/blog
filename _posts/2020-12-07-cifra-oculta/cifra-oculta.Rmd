...
```{r, tab.cap="Tabela 1: Quantidade de observações por assunto genérico"}
assuntos %>%
...
assuntos %>%
  ...
  labs(title = "Gráfico 2: Contagem de casos por Tribunal",
       x = "Quantidade",
       y = "Tribunais") +
  theme_minimal(12)
```
...
assuntos %>%
  ...
  theme_minimal(9.5) +
  plot_annotation("Gráfico 3: Taxa de cifra oculta por Assunto",
                  theme = theme(plot.title = element_text(size = rel(1.5)))) +
