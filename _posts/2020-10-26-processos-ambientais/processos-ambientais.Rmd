...
A base de intervenções ambientais possui `r nrow(da_intervencao)` casos. A Figura \@ref(fig:intervencoes-decisao) mostra a proporção de cada desfecho dos processos. É possível observar que aproximadamente `r p_def` dos casos são deferidos.
