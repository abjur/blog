...
author:
  - name: Tadeu A. Sena Gomes
    url: mailto:tg@senagomes.adv.br
date: 03-12-2021
output:
  distill::distill_article:
    self_contained: false
preview: "img/grafico_1.png"
---
...
uma eventual ação legislativa mais racional^["O jurista, por mais respeitado e 
...
```{r echo=FALSE, out.width='40%', out.extra='style="float:left; padding-right:20px"'}
knitr::include_graphics("img/foto.jpeg")
```

*Tadeu A. Sena Gomes é associado da ABJ e escreveu para o Lab ABJ a convite da associação.* 

Contato: [tg@senagomes.adv.br](mailto:tg@senagomes.adv.br) | [Instagram](https://www.instagram.com/tsenagomes/) | [Twitter](https://www.twitter.com/tsenagomes)
:::
