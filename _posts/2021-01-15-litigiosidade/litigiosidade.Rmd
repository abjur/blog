...
base_litigiosidade %>% 
  ...
  dplyr::rename("Taxa de litigiosidade" = taxa, "Município" = muni_nm, "Região" = regiao_nm) %>% 
...
```{r fig.cap = "Litigiosidade por IDHM educação", layout="l-body-outset", eval = TRUE, echo = FALSE}
...
base_litigiosidade %>%
  ...
  ggplot2::geom_point(aes(x = idhm_e,  y = taxa), color = "#102C68", size = .5)  +
...
```{r litigiosidade-gini, fig.cap = "Litigiosidade por gini", layout="l-body-outset", eval = TRUE, echo = FALSE}
base_litigiosidade %>%
