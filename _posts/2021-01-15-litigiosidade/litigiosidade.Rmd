...
base_litigiosidade %>%
  ...
  ggplot2::geom_point(aes(x = idhm_e,  y = taxa_log), color = "#102C68", size = .5)  +
...
base_litigiosidade %>%
  ...
  ggplot2::ggplot() +
  ggplot2::geom_col(aes(x = gini, y = taxa, fill = regiao_nm))+
  scale_fill_discrete(name="Região")+
  # viridis::scale_fill_viridis() +
  #scale_color_discrete(values = c("orange", "black", "red", "blue", "green"))+
